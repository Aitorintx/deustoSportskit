	...
	do {
		...
		if (bytes > 0) {
			if(strcmp(recvBuff, "Numero de Clientes") == 0){
				...
				printf("Data sent: [Numero de Clientes] %s \n", numC);
			}
			...
			if(strcmp(recvBuff, "Numero de Clientes VIP") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Numero de Clientes VIP] %s \n", sendBuff);
			}
			...
			if(strcmp(recvBuff, "Numero de Productos") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Numero de Productos] %s \n", sendBuff);
			}
			...
			if(strcmp(recvBuff, "Numero de Compras") == 0){
				...
				strcpy(sendBuff, numC);
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Numero de Compras] %s \n", sendBuff);
			}
			...
			if(strcmp(recvBuff, "Quiero el ID de los Clientes") == 0){
				...
				strcpy(sendBuff, idC);
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [ID de los Clientes] %s \n", sendBuff);
				punteroIDC++;
			}
			...
			if(strcmp(recvBuff, "Quiero el ID de los Clientes VIP") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [ID de los Clientes VIP] %s \n", sendBuff);
				punteroIDCV++;
			}
			...
			if(strcmp(recvBuff, "Quiero Los Nombres de los Clientes") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Nombres de los Clientes] %s \n", sendBuff);
				punteroNombresC++;
			}
			...
			if(strcmp(recvBuff, "Quiero Los Nombres de los Clientes VIP") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Nombres de los Clientes VIP] %s \n", sendBuff);
				punteroNombreCV++;
			}
			...
			if(strcmp(recvBuff, "Quiero el telefono de los clientes") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [telefono de los clientes] %s \n", sendBuff);
				puntTelC++;
			}
			...
			if(strcmp(recvBuff, "Quiero el telefono de los clientes VIP") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [telefono de los clientes VIP] %s \n", sendBuff);
				puntTelCV++;
			}
			...
			if(strcmp(recvBuff, "Quiero los CORREOS de los Clientes") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [CORREOS de los Clientes] %s \n", sendBuff);
				puntCorC++;
			}
			...
			if(strcmp(recvBuff, "Quiero los CORREOS de los Clientes VIP") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [CORREOS de los Clientes VIP] %s \n", sendBuff);
				puntCorCV++;
			}
			...
			if(strcmp(recvBuff, "Quiero las direcciones de los Clientes") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [direcciones de los Clientes] %s \n", sendBuff);
				puntDirC++;
			}
			...
			if(strcmp(recvBuff, "Quiero las direcciones de los Clientes VIP") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [direcciones de los Clientes VIP] %s \n", sendBuff);
				puntDirCV++;
			}
			...
			if(strcmp(recvBuff, "Quiero Las Contraseñas de los Clientes") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Contraseñas de los Clientes] %s \n", sendBuff);
				puntContraC++;
			}
			...
			if(strcmp(recvBuff, "Quiero Las Contraseñas de los Clientes VIP") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Contraseñas de los Clientes VIP] %s \n", sendBuff);
				puntContraCV++;
			}
			...
			if(strcmp(recvBuff, "Quiero Los Niveles de los Clientes VIP") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Niveles de los Clientes VIP] %s \n", sendBuff);
				puntNivel++;
			}
			...
			if(strcmp(recvBuff, "Quiero el ID de los Productos") == 0){
				...
				strcpy(sendBuff, idP);
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [ID de los Productos] %s \n", sendBuff);
				puntIDP++;
			}
			...
			if(strcmp(recvBuff, "Quiero el Nombre de los Productos") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Nombre de los Productos] %s \n", sendBuff);
				puntNomP++;
			}
			...
			if(strcmp(recvBuff, "Quiero el Tipo de los Productos") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Tipo de los Productos] %s \n", sendBuff);
				puntTipo++;
			}
			...
			if(strcmp(recvBuff, "Quiero el precio de los Productos") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [precio de los Productos] %s \n", sendBuff);
				puntPrecio++;
			}
			...
			if(strcmp(recvBuff, "Quiero el Stock de los Productos") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [Stock de los Productos] %s \n", sendBuff);
				puntStock++;
			}
			...
			if(strcmp(recvBuff, "Quiero la talla de los Productos") == 0){
				...
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [talla de los Productos] %s \n", sendBuff);
				puntTalla++;
			}
			...
			if(strcmp(recvBuff, "Quiero el ID de las Compras") == 0){
				...
				strcpy(sendBuff, idP);
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [ID de las Compras] %s \n", sendBuff);
				puntIDC++;
			}
			...
			if(strcmp(recvBuff, "Quiero el ID del Producto") == 0){
				...
				strcpy(sendBuff, idP);
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [ID del Producto] %s \n", sendBuff);
				puntIDProd++;
			}
			...
			if(strcmp(recvBuff, "Quiero el ID del Comprador") == 0){
				...
				strcpy(sendBuff, idP);
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [ID del Comprador] %s \n", sendBuff);
				puntidComprador++;
			}
			...
			if(strcmp(recvBuff, "Quiero el MAX ID de la Compra") == 0){
				...
				strcpy(sendBuff, idP);
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [MAX ID de la Compra] %s \n", sendBuff);
			}
			...
			if(strcmp(recvBuff, "Quiero el numero Real de Compras") == 0){
				...
				strcpy(sendBuff, idP);
				send(comm_socket, sendBuff, sizeof(sendBuff), 0);
				printf("Data sent: [numero Real de Compras] %s \n", sendBuff);
			}
